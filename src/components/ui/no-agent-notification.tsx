...
export function NoAgentNotification(props: NoAgentNotificationProps) {
  ...
  return (
    <>
      {showNotification ? (
<<<<<<< HEAD
        <div className="fixed text-sm left-3/4 max-w-[90vw] -translate-x-1/2 flex top-6 items-center gap-4 bg-foreground text-background px-4 py-3 rounded-lg z-10">
=======
        <div className="fixed text-sm left-3/4 max-w-[90vw] -translate-x-1/2 flex top-6 items-center gap-4 bg-foreground px-4 py-3 rounded-lg z-10">
